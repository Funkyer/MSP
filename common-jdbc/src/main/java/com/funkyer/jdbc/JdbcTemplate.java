...
public class JdbcTemplate extends SqlMapClientDaoSupport 
{
	...
	public List<Object> query(String statementName,Map<String,Object> parameterObject)
	{
	...
	public void delete(String statementName,Map<String,Object> parameterObject)
	{
