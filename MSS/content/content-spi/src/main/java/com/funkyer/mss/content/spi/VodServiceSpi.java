package com.funkyer.mss.content.spi;
...
import com.funkyer.mss.content.spi.convert.VodConvert;
import com.funkyer.mss.content.api.VodService;
...
public class VodServiceSpi implements VodService {
    ...
    public GetVodByIdResponse getVodById(GetVodByIdRequest request) {
        ...
        if(null == vod)
        {
            com.funkyer.msm.content.api.domain.Vod v = new com.funkyer.msm.content.api.domain.Vod();
            ...
            {
                v = (com.funkyer.msm.content.api.domain.Vod)vods.get(0);
